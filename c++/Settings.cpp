...
void Settings::initialize(std::vector < std::vector<std::string> > settings)
{
    ...
    settings_str["area_fact"] =                   settings.at(29).at(1);
    settings_str["pet_fact"] =                    settings.at(30).at(1);
    settings_str["heat_trans_solver"] =           settings.at(31).at(1);
    settings_str["iter_stop_heat"] =              settings.at(32).at(1);
    settings_str["iter_cut_thresh_heat"] =        settings.at(33).at(1);
    settings_str["implicity_heat"] =              settings.at(34).at(1);
    settings_str["bis_iter_cut_thresh_heat"] =    settings.at(35).at(1);
    settings_str["bis_iter_stop_heat"] =          settings.at(36).at(1);
    settings_str["bis_iter_cut_left_heat"] =      settings.at(37).at(1);
    settings_str["bis_iter_cut_right_heat"] =     settings.at(38).at(1);
    settings_str["lat_heat_fus"] =                settings.at(39).at(1);
    settings_str["temp_freez"] =                  settings.at(40).at(1);
    settings_str["mult_freez"] =                  settings.at(41).at(1);
    settings_str["dens_air"] =                    settings.at(42).at(1);
    settings_str["dens_ice"] =                    settings.at(43).at(1);
    settings_str["dens_wat"] =                    settings.at(44).at(1);
    settings_str["cap_air"] =                     settings.at(45).at(1);
    settings_str["cap_ice"] =                     settings.at(46).at(1);
    settings_str["cap_wat"] =                     settings.at(47).at(1);
    settings_str["cond_air"] =                    settings.at(48).at(1);
    settings_str["cond_ice"] =                    settings.at(49).at(1);
    settings_str["cond_wat"] =                    settings.at(50).at(1);
    settings_str["cond_mult_air"] =               settings.at(51).at(1);
    settings_str["cond_mult_ice"] =               settings.at(52).at(1);
    settings_str["cond_mult_wat"] =               settings.at(53).at(1);
    settings_str["temp_soil_init"] =              settings.at(54).at(1);
    settings_str["use_phreeqcrm"] =               settings.at(55).at(1);
    settings_str["sol_trans_solver"] =            settings.at(56).at(1);
    settings_str["iter_stop_sol"] =               settings.at(57).at(1);
    settings_str["iter_cut_thresh_sol"] =         settings.at(58).at(1);
    settings_str["implicity_sol"] =               settings.at(59).at(1);
    settings_str["mol_diff_rate"] =               settings.at(60).at(1);
    settings_str["network_link_file_path_in"] =   settings.at(61).at(1);
    settings_str["network_junc_file_path_in"] =   settings.at(62).at(1);
    settings_str["mesh_2d_file_path_in"] =        settings.at(63).at(1);
    settings_str["mesh_3d_file_path_in"] =        settings.at(64).at(1);
    settings_str["grid_map_file_path_in"] =       settings.at(65).at(1);
    settings_str["materials_net_junc_path"] =     settings.at(66).at(1);
    settings_str["materials_net_link_path"] =     settings.at(67).at(1);
    settings_str["materials_2d_path"] =           settings.at(68).at(1);
    settings_str["materials_3d_path"] =           settings.at(69).at(1);
    settings_str["init_cond_net_junc_path"] =     settings.at(70).at(1);
    settings_str["init_cond_net_link_path"] =     settings.at(71).at(1);
    settings_str["init_cond_2d_path"] =           settings.at(72).at(1);
    settings_str["init_cond_3d_path"] =           settings.at(73).at(1);
    settings_str["bound_cond_net_junc_path"] =    settings.at(74).at(1);
    settings_str["bound_cond_net_link_path"] =    settings.at(75).at(1);
    settings_str["bound_cond_2d_path"] =          settings.at(76).at(1);
    settings_str["bound_cond_3d_path"] =          settings.at(77).at(1);
    settings_str["atmos_forcing_data_path"] =     settings.at(78).at(1);
    settings_str["solute_properties_path"] =      settings.at(79).at(1);
    settings_str["phreeqc_input_path"] =          settings.at(80).at(1);
    settings_str["phreeqc_chem_db_path"] =        settings.at(81).at(1);
    settings_str["phreeqc_spec_map_path"] =       settings.at(82).at(1);
    settings_str["phreeqc_mol_weight_map_path"] = settings.at(83).at(1);
    settings_str["output_csv_path"] =             settings.at(84).at(1);
    settings_str["output_link_vtk_path"] =        settings.at(85).at(1);
    settings_str["output_junc_vtk_path"] =        settings.at(86).at(1);
    settings_str["output_surf_vtk_path"] =        settings.at(87).at(1);
    settings_str["output_subs_vtk_path"] =        settings.at(88).at(1);
