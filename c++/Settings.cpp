...
void Settings::initialize(std::vector < std::vector<std::string> > settings)
{
    ...
    settings_str["mesh_2d_file_path_in"] =        settings.at(53).at(1);
    settings_str["mesh_3d_file_path_in"] =        settings.at(54).at(1);
    settings_str["grid_map_file_path_in"] =       settings.at(55).at(1);
    settings_str["materials_2d_path"] =           settings.at(56).at(1);
    settings_str["materials_3d_path"] =           settings.at(57).at(1);
    settings_str["init_cond_2d_path"] =           settings.at(58).at(1);
    settings_str["init_cond_3d_path"] =           settings.at(59).at(1);
    settings_str["bound_cond_2d_path"] =          settings.at(60).at(1);
    settings_str["bound_cond_3d_path"] =          settings.at(61).at(1);
    settings_str["atmos_forcing_data_path"] =     settings.at(62).at(1);
    settings_str["solute_properties_path"] =      settings.at(63).at(1);
    settings_str["phreeqc_input_path"] =          settings.at(64).at(1);
    settings_str["phreeqc_chem_db_path"] =        settings.at(65).at(1);
    settings_str["phreeqc_spec_map_path"] =       settings.at(66).at(1);
    settings_str["phreeqc_mol_weight_map_path"] = settings.at(67).at(1);
    settings_str["output_csv_Path"] =             settings.at(68).at(1);
    settings_str["output_surf_vtk_path"] =        settings.at(69).at(1);
    settings_str["output_subs_vtk_Path"] =        settings.at(70).at(1);
